...
public class StateDemoReduced {
	...
	public static void main(String[] args) throws Exception {
		...
		sum.writeAsText("/Flink/state/reducedstate");

		// execute program
		env.execute("reduced State");
	}
	...
	public static class StatefulMap extends RichFlatMapFunction<Tuple2<Long, String>, Long> {
		...
		public void open(Configuration conf) {
			...
			ReducingStateDescriptor<Long> sumDesc = new ReducingStateDescriptor<Long>("reducing sum", new SumReduce(),
					Long.class);
