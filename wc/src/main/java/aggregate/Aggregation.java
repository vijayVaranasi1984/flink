...
public class Aggregation {
	public static void main(String[] args) throws Exception {
		...
		//mapped.keyBy(0).sum(3).writeAsCsv(params.get("output1"));
		mapped.keyBy(0).sum(3).writeAsText("/home/vijay/out1");

		mapped.keyBy(0).min(3).writeAsText("/home/vijay/out2");

		mapped.keyBy(0).minBy(3).writeAsText("/home/vijay/out3");

		mapped.keyBy(0).max(3).writeAsText("/home/vijay/out4");

		mapped.keyBy(0).maxBy(3).writeAsText("/home/vijay/out5");
