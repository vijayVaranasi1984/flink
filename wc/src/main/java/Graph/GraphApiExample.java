...
public class GraphApiExample {
	...
	private static final String user1Name = "Vijay";
	...
	public static void main(String[] args) throws Exception {
		...
		/* format: user, friend */
		DataSet<Tuple2<String, String>> friends = env.readTextFile("/Flink/graphAPI/graph_data")
		...
		fOfUser1.writeAsText("/Flink/graphAPI/result1.txt");
