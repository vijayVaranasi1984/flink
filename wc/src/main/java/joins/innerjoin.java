...
public class innerjoin {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple2<Integer, String>> personSet = env.readTextFile(params.get("input1"))
				.map(new MapFunction<String, Tuple2<Integer, String>>()               // presonSet = tuple of (1 John) PERSON.TXT
				{
		...
		DataSet<Tuple2<Integer, String>> locationSet = env.readTextFile(params.get("input2"))
				.map(new MapFunction<String, Tuple2<Integer, String>>() { // locationSet = tuple of (1 DC) LOCATION.TXT
					public Tuple2<Integer, String> map(String value) {
		...
		DataSet<Tuple3<Integer, String, String>> joined = personSet.join(locationSet).where(0).equalTo(0) // first field of person set is equal to first field of location set
				.with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>() {// tuple2 for person and location and output tuple3
		...
		joined.writeAsCsv(params.get("joinoutput"), "\n", " ");
