...
public class SplitDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<String> text = env.readTextFile("/Flink/splitoperator/oddeven.txt");
		...
		evenData.writeAsText("/Flink/splitoperator/even");
		oddData.writeAsText("/Flink/splitoperator/odd");
