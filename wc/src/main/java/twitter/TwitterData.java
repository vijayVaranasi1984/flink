...
public class TwitterData {
	public static void main(String[] args) throws Exception {
		...
		twitterCredentials.setProperty(TwitterSource.CONSUMER_SECRET,
				"8XzIDXlVLQANLsItrALwx3dHtyVvq4vrZu2OYSfhEqFsSEKI12");
		...
		twitterData.flatMap(new TweetParser()).writeAsText("/Flink/twitterdataingestion/tweetOutput");
	...
	public static class TweetParser implements FlatMapFunction<String, Tuple2<String, Integer>> {
		...
		public void flatMap(String value, Collector<Tuple2<String, Integer>> out) throws Exception {
			...
			boolean isEnglish = node.has("user") 
