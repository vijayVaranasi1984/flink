...
public class AverageProfitSession {
	public static void main(String[] args) throws Exception {
		...
		DataStream<String> data = env.socketTextStream("localhost", 9092);
		...
		DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped.keyBy(0)
				.window(ProcessingTimeSessionWindows.withGap(Time.seconds(1)))// gap of 1 sec
		...
		reduced.writeAsText("/Flink/Sessionwindowswithprocessingtime/www");
